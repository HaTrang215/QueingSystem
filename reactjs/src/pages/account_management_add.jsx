...
const submitEquipment = (e)=>{
  ...
  axios.get('/sanctum/csrf-cookie').then(response => {
      axios.post('/api/add-account',data)
      .then(res =>{
          if(res.data.status === 200){
  ...
  return (
    <div className="container">
      ...
      <div className="content">
        <Topbar title1='Cài đặt hệ thống' title2='Quản lý tài khoản' title3='Thêm tài khoản'/>
            ...
            <div className="background-content">
              ...
              <div className="row-item1">
                <div className="add-button">
                    ...
                    <button className="btn-add" onClick={submitEquipment}>Thêm</button>
                </div>
              </div>
            </div>
          </div>
...
export default account_management_add