...
const submitService = (e)=>{
  ...
  axios.get('/sanctum/csrf-cookie').then(response => {
      axios.post('/api/add-service',data)
      .then(res =>{
  ...
  return (
    <div className="container">
      ...
      <div className="content">
        <Topbar title1='Dịch vụ' title2='Danh sách dịch vụ' title3='Thêm dịch vụ'/>
            ...
            <div className="add-content">
              ...
              <div className="row-item1">
                <div className="add-button">
                    ...
                    <button className="btn-add" onClick={submitService}>Thêm dịch vụ</button>
                </div>
              </div>
            </div>
          </div>
