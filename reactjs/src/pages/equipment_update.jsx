...
const submitEquipment = (e)=>{
  ...
  axios.get('/sanctum/csrf-cookie').then(response => {
      axios.post('/api/update-equipment',data)
      .then(res =>{
          if(res.data.status === 200){
  ...
  return (
    <div className="container">
      ...
      <div className="content">
        <Topbar title1='Thiết bị' title2='Danh sách thiết bị' title3='Cập nhật thiết bị'/>
...
export default equipment_update